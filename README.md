...
- `reports/`: Data quality md reports, ERD models, and Business KPI PNG visualizations.
- `logs/`: Runtime logs generated by pipeline executions (`pipeline.log`).
- `great_expectations/`: Generated Expectations configuration and Data Docs.
- `Exploratory_ETL.ipynb`: Consolidated Jupyter Notebook validating the methodology before script decomposition.
